import type { CompetitionStage, ScoringCriteria, FAQ, Judge, SponsorshipPackage, Certificate, JourneyStep, SocialLink } from "@shared/schema";
...
export const chatbotResponses = [
  {
    question: "كيف أسجل في المسابقة؟",
    answer: "يمكنك التسجيل من خلال الضغط على زر 'طلب عرض' في الصفحة الرئيسية وملء نموذج التسجيل."
  },
  {
    question: "متى يبدأ التسجيل؟",
    answer: "سيتم الإعلان عن موعد بدء التسجيل قريباً. تابعونا على منصات التواصل الاجتماعي."
  },
  {
    question: "ما هي متطلبات المشاركة؟",
    answer: "يجب أن يكون المشارك لديه خلفية في المجال المالي أو طالب في تخصص ذي صلة."
  },
  {
    question: "هل المسابقة مجانية؟",
    answer: "سيتم الإعلان عن تفاصيل الرسوم عند فتح باب التسجيل."
  }
];
